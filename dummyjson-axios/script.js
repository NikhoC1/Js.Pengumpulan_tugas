...
// Data Pelanggan
function allpel() {
    axios.get("http://localhost/dummyjson-php/php/select.php").then(function (response) {
...
function addpel() {
    ...
    axios.post("http://localhost/dummyjson-php/php/insert.php",JSON.stringify(data)).then(function (response) {
        // alert(response.data);
...
function showpel(idpelanggan) {
    ...
    axios.post("http://localhost/dummyjson-php/php/selectupdate.php",JSON.stringify(data)).then(function (response) {
...
function updtpel() {
    ...
    axios.post("http://localhost/dummyjson-php/php/update.php",JSON.stringify(dataPel)).then(function (response) {
        // alert(response.data);
...
function delpel(idpel) {
    ...
    axios.post("http://localhost/dummyjson-php/php/delete.php",JSON.stringify(data)).then(function (response) {
        // alert(response.data);
        swal({
            title: "Succes",
...
function cartpel(idpelanggan) {
    let namapemesan = document.querySelector("#namapemesan");
    axios.get("http://localhost/dummyjson-php/php/selectwhere.php/?id=" + idpelanggan).then(function (response) {
...
function orderr(idbarang, harga, barang) {
    ...
    console.log(data);
    axios.post("http://localhost/dummyjson-php/php/addtocart.php",JSON.stringify(data)).then(function (response) {
